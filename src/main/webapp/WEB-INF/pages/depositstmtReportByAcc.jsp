...
<body>
		...
		<div>
			<div class="report_bg_patch">
				<div class="row text-center">
					<h3 style="width: 100%;">Deposit  Statement</h3>
				</div>
				<div class="col-md-3 b-b b-r b-l b-t b-grey loan_label"
					style="padding-bottom: 253px;background-color: honeydew;">
					<div class="row text-center">
					<h5 style="width: 100%;">Get Deposit Statement</h5>
				</div>
					<form id="form" method="POST" action="printdepositStmnt"
	...
	<div id="dialog" style="display: none">
		...
		<script type="text/javascript" src="js/depositstmtreport.js"></script>
		<script>
